...
class TestNetworkReset:
    ...
    def test_receive_message_after_server_restart(self, start_stop_capable_server: Callable[[], SpawnProcess], sender: Sender, receiver: Callable[..., Receiver]):
    ...
    def test_receive_after_switching_network(self, start_stop_capable_server: Callable[[], SpawnProcess], sender: Sender, receiver: Callable[..., Receiver]):
        server_process = None
        try:
    ...
    def test_autorecover_from_network_switch(self, start_stop_capable_server: Callable[[], SpawnProcess], sender: Sender, receiver: Callable[..., Receiver]):
        server_process = None
        try:
            server_process: SpawnProcess = start_stop_capable_server()
            source:Sender = sender()
    ...
    def test_missed_msg(self, start_stop_capable_server: Callable[[], SpawnProcess], sender: Sender, receiver: Callable[..., Receiver]):
        server_process: SpawnProcess | None = None
        try:
            server_process = start_stop_capable_server()
            source:Sender = sender()

...
s = Series ("Test series")
s.add(0.1, 1)
s.add(0.2, 2)
s.add(0.3, 3)
s.add(0.4, 4)

ptItem = pg.PlotItem(title="Test Plot", left="Data", bottom="Seconds")
curve=ptItem.plot(s.times, s.points, pen='y')
curve.setData(s.times, s.points)

w4 = pg.PlotWidget(plotItem=ptItem)

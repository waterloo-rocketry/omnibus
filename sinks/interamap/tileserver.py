...
def check_tileserver_installed():
    ...
    try:
        subprocess.run(["tileserver-gl", "--version"], check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
if __name__ == "__main__":
    # Argument parsing
    parser = argparse.ArgumentParser(description='Start tileserver-gl with a specific .mbtiles file.')
    parser.add_argument('mbtiles_file', help='The path to the .mbtiles file')
